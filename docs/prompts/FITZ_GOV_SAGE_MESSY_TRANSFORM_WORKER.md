...
- Preserve source_id, query, labels, and scalar_targets. Do not relabel.
- query_planning row: contexts=[], text="Question: <query>", labels copied from source labels except label_id=-1 and taxonomy_pattern=null, scalar_targets={}. This row trains pre-retrieval planning only.
