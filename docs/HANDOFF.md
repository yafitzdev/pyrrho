...
- A separate Claude-generated candidate handoff exists at `C:/Users/yanfi/PycharmProjects/fitz-gov/data/sdgp_handoff_v8_candidate_20260525_claude_expand/`. It is **not active data** and **not pyrrho training data**. Generation was still moving during the 2026-05-25 evening inspection; the 18:09 snapshot saw **89** main `batch_*.jsonl` files, **2,646** raw lines, **2,643** parseable unique candidate IDs, **0** duplicate IDs, **3** malformed JSON lines, and **15** parsed rows missing core classification/domain/difficulty fields. Normalize and run the clean testcase addition cycle before any merge.
...
- **fitz-gov V8 candidate handoff**: Claude generated additional V8 candidate rows under `C:/Users/yanfi/PycharmProjects/fitz-gov/data/sdgp_handoff_v8_candidate_20260525_claude_expand/`. This handoff is unvalidated and unmerged. The 2026-05-25 18:09 snapshot observed **2,643** parseable unique candidate IDs plus malformed/incomplete rows, and the folder was still changing. Do not point pyrrho at this handoff or merge it into the active vault until structural dry-run and offline blind-label QA both pass.
