...
| Targeted patches | 180 rows | 720 + 360 + 180 rows | Complete locally; patch blind-label QA still required before merge/publish |
...
`constant_config_conflict` mechanism across all three seeds. A later
