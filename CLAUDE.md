...
2. **[docs/ROADMAP.md](docs/ROADMAP.md)** — current vision: model tiers (`pyrrho-nano` / `-small` / `-MoE`), fitz-gov data path (V5.1 → V6 → V7), training phases through pyrrho-MoE. Supersedes PROJECT.md §10 release table.
...
- **Benchmark**: fitz-gov v5. No v6 data work until pyrrho-nano-g1.1 (V5.1-enriched retrain) ships per ROADMAP.md Phase 1.
